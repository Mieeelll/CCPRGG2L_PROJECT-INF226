...
public class EasyMode implements ActionListener {
    ...
    EasyMode(Color colorX, Color colorO) {
        ...
        textfield.setText("TicTacToe Game");
        textfield.setOpaque(true);

        nameplayer.setBackground(new Color(255, 255, 225));
        nameplayer.setForeground(new Color(0, 0, 128));
        nameplayer.setFont(new Font("Consolas", Font.BOLD, 20));
        nameplayer.setHorizontalAlignment(JLabel.CENTER);
        nameplayer.setText("Player 1 : " + Nameplayero +"     "+
                           "Player 2 : " + Nameplayerx);
    ...
    UIManager.put("OptionPane.questionIcon", new ImageIcon("GG.png"));
    int result = JOptionPane.showConfirmDialog(null, "TRY AGAIN?", "Its a Draw!", JOptionPane.YES_NO_OPTION);
...
public void xWins(int a, int b, int c) {
    ...
    int result = JOptionPane.showConfirmDialog(null, "PLAY AGAIN?", Nameplayerx + " won the game!", JOptionPane.YES_NO_OPTION);
...
public void oWins(int a, int b, int c) {
    ...
    int result = JOptionPane.showConfirmDialog(null, "PLAY AGAIN?", Nameplayero + " won the game!", JOptionPane.YES_NO_OPTION);
